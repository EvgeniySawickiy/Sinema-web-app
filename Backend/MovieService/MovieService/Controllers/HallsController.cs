...
namespace MovieService.Controllers
{
    ...
    public class HallsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<Guid>> CreateHall([FromBody] CreateHallCommand command,
        ...
        [Authorize(Roles = "Admin")]
        [HttpPut("{id:guid}")]
        public async Task<IActionResult> UpdateHall(Guid id, [FromBody] UpdateHallCommand command,
            CancellationToken cancellationToken)
        {
